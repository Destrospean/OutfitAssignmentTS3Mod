...
namespace Destrospean
{
    public class InteractionInstanceAdditions
    {
        ...
        {
            Type type = typeof(InteractionInstanceAdditions);
            ReplaceMethod(typeof(InteractionInstance).GetMethod("RunInteractionWithoutCleanup", Array.ConvertAll(type.GetMethod("RunInteractionWithoutCleanup").GetParameters(), x => x.ParameterType)), type.GetMethod("RunInteractionWithoutCleanup"));
            ReplaceMethod(typeof(InteractionInstance).GetMethod("StandardEntry", Array.ConvertAll(type.GetMethod("StandardEntry").GetParameters(), x => x.ParameterType)), type.GetMethod("StandardEntry"));
            ReplaceMethod(typeof(InteractionInstance).GetMethod("StandardExit", Array.ConvertAll(type.GetMethod("StandardExit").GetParameters(), x => x.ParameterType)), type.GetMethod("StandardExit"));
            ReplaceMethod(typeof(Sim).GetMethod("WaitForSynchronizationLevelWithSim", Array.ConvertAll(type.GetMethod("WaitForSynchronizationLevelWithSim").GetParameters(), x => x.ParameterType)), type.GetMethod("WaitForSynchronizationLevelWithSim"));
        }
